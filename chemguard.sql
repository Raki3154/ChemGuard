...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2025 at 07:29 AM
...
INSERT INTO `users` (`id`, `plant_name`, `plant_id`, `password`, `country`, `state`, `city`, `industry_type`) VALUES
(1, 'aksh', '001', '$2y$10$O3n76TkNxGLwma3N./Z/Geqp7MPMfacOnZkHS.eRP115iDQS8WBVi', 'India', 'Tamil Nadu', 'Tuticorin', 'Power Plant'),
(2, 'Dani', '010', '$2y$10$MGfeXCaGWUq/Y0dgY7S4TeqnK9Jwtp1dK8/ZyMmptKBhz5hZlQxRu', 'India', 'Tamil Nadu', 'Coimbatore', 'Power Plant');
